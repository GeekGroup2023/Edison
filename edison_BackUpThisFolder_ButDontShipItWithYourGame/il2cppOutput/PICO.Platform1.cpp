...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void Room__ctor_mB6AF794D98BC22F1081870DD63E403520D1172A4 (Room_tBD64D83E5B1B76A68476651AB2E548F1587A1135* __this, intptr_t ___0_o, const RuntimeMethod* method) 
{
	...
	memset((&V_1), 0, sizeof(V_1));
	{
		...
		intptr_t L_0 = ___0_o;
		intptr_t L_1;
		L_1 = CLIB_ppf_Room_GetDataStore_mD837F6F5F9D8454C3CED911061B3182798B58A75(L_0, NULL);
		Dictionary_2_t46B2DB028096FA2B828359E52F37F3105A83AD83* L_2;
		L_2 = CLIB_DataStoreFromNative_m765A5372300BCCB3279F02A012FDDF4E30ED626A(L_1, NULL);
		...
		intptr_t L_3 = ___0_o;
		String_t* L_4;
		L_4 = CLIB_ppf_Room_GetDescription_m0B3F47015616F855934978A1E3363FF8133B2B2D(L_3, NULL);
		__this->___Description_1 = L_4;
		Il2CppCodeGenWriteBarrier((void**)(&__this->___Description_1), (void*)L_4);
		// RoomId = CLIB.ppf_Room_GetID(o);
		intptr_t L_5 = ___0_o;
		uint64_t L_6;
		L_6 = CLIB_ppf_Room_GetID_mA3F30744CFD4B32773033B92C35D36EDCFC52302(L_5, NULL);
		__this->___RoomId_2 = L_6;
		// IsMembershipLocked = CLIB.ppf_Room_GetIsMembershipLocked(o);
		intptr_t L_7 = ___0_o;
		bool L_8;
		L_8 = CLIB_ppf_Room_GetIsMembershipLocked_m1B8FC8CD5743C03D290C0D1252D3254AE6E36137(L_7, NULL);
		__this->___IsMembershipLocked_3 = L_8;
		// RoomJoinPolicy = (RoomJoinPolicy) CLIB.ppf_Room_GetJoinPolicy(o);
		intptr_t L_9 = ___0_o;
		int32_t L_10;
		L_10 = CLIB_ppf_Room_GetJoinPolicy_m9D566A4693F674501E54329CA22962C45D4356AB(L_9, NULL);
		__this->___RoomJoinPolicy_4 = L_10;
		// RoomJoinability = (RoomJoinability) CLIB.ppf_Room_GetJoinability(o);
		intptr_t L_11 = ___0_o;
		int32_t L_12;
		L_12 = CLIB_ppf_Room_GetJoinability_mCA89ED58AAB4D55330CFFB99E77AD3126DB2C52A(L_11, NULL);
		__this->___RoomJoinability_5 = L_12;
		// MaxUsers = CLIB.ppf_Room_GetMaxUsers(o);
		intptr_t L_13 = ___0_o;
		uint32_t L_14;
		L_14 = CLIB_ppf_Room_GetMaxUsers_m72EAD2F61A6C02DFC70142B2D8FA1D8B623B6159(L_13, NULL);
		__this->___MaxUsers_6 = L_14;
		// Name = CLIB.ppf_Room_GetName(o);
		intptr_t L_15 = ___0_o;
		String_t* L_16;
		L_16 = CLIB_ppf_Room_GetName_m87A770FD459F4539848860C47986204CCEE10162(L_15, NULL);
		__this->___Name_10 = L_16;
		Il2CppCodeGenWriteBarrier((void**)(&__this->___Name_10), (void*)L_16);
		// RoomType = (RoomType) CLIB.ppf_Room_GetType(o);
		intptr_t L_17 = ___0_o;
		int32_t L_18;
		L_18 = CLIB_ppf_Room_GetType_mA5FCEBA4DC0D3B9D9DDCE628BFC7009C0398FF4B(L_17, NULL);
		__this->___RoomType_8 = L_18;
		// var ptr = CLIB.ppf_Room_GetOwner(o);
		intptr_t L_19 = ___0_o;
		intptr_t L_20;
		L_20 = CLIB_ppf_Room_GetOwner_m431345003BF1B39434CBC260A90E38C1D582180C(L_19, NULL);
		V_0 = L_20;
		// if (ptr == IntPtr.Zero)
		intptr_t L_21 = V_0;
...
IL_0094:
	{
		...
		intptr_t L_24 = V_0;
		User_t37DF053AC9F41CDB2B22463F16BE016A70A2C2A4* L_25 = (User_t37DF053AC9F41CDB2B22463F16BE016A70A2C2A4*)il2cpp_codegen_object_new(User_t37DF053AC9F41CDB2B22463F16BE016A70A2C2A4_il2cpp_TypeInfo_var);
		NullCheck(L_25);
		User__ctor_m0A17383A33457E27EB6AD299C81C77AC1802E0D1(L_25, L_24, NULL);
		__this->___OwnerOptional_7 = L_25;
		Il2CppCodeGenWriteBarrier((void**)(&__this->___OwnerOptional_7), (void*)L_25);
	}
...
IL_00a0:
	{
		...
		intptr_t L_26 = ___0_o;
		intptr_t L_27;
		L_27 = CLIB_ppf_Room_GetUsers_mEEBAF8CF27478C8D3DACBACBF5465AC8A887F4A9(L_26, NULL);
		V_1 = L_27;
		// if (ptr == IntPtr.Zero)
		intptr_t L_28 = V_1;
...
IL_00bc:
	{
		...
		__this->___UsersOptional_9 = L_32;
		Il2CppCodeGenWriteBarrier((void**)(&__this->___UsersOptional_9), (void*)L_32);
		// }
		return;
	}
}
...
{
	{
		...
		String_t* L_25;
		L_25 = CLIB_ppf_User_GetSmallImageUrl_m16BE75B35032EA60BE97C76FBE1F9436F7B5BD89(L_24, NULL);
		__this->___SmallImageUrl_2 = L_25;
		Il2CppCodeGenWriteBarrier((void**)(&__this->___SmallImageUrl_2), (void*)L_25);
		// InviteToken = CLIB.ppf_User_GetInviteToken(obj);
		intptr_t L_26 = ___0_obj;
		String_t* L_27;
		L_27 = CLIB_ppf_User_GetInviteToken_m758417F040077D7413AD6E6B70A8F90C3DC44D17(L_26, NULL);
		...
		String_t* L_29;
		L_29 = CLIB_ppf_User_GetStoreRegion_mE2E6D71E336324B0AF7AC2196293C613B85624BF(L_28, NULL);
